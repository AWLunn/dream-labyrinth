 ...
 */
	...
	public void StoryGeneration(Pane playfieldLayer) {
		...
		case 1:
			...
			trials.radialFormation(150, 100, 50, 0, 360, 72);
			trials.radialFormation(600, 100, 50, 0, 360, 72);
			break;
		case 2:
			trials = new EnemyFormation("donut", currentLevel, level);
			trials.radialFormation(SCRN_WIDTH/2, SCRN_HEIGHT/2, 150, 0, 360, 36);
		...
		case 3:
			...
			trials.unformalFormation(200, 75, 150, 120, 60, 60);
			break;
		case 4:
			...
			trials.radialFormation(600, 100, 50, 0, 360, 36);
			trials = new EnemyFormation("melon", currentLevel, level);
			trials.unformalFormation(200, 75, 150, 120, 60, 60);
			break;			
		case 5:
